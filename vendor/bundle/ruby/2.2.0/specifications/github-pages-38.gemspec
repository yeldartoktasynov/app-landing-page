...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<redcarpet>, ["= 3.3.1"])
      ...
      s.add_runtime_dependency(%q<jekyll-feed>, ["= 0.3.0"])
      ...
      s.add_dependency(%q<redcarpet>, ["= 3.3.1"])
      ...
      s.add_dependency(%q<jekyll-feed>, ["= 0.3.0"])
